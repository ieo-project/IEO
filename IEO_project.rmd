---
title: "IEO_PROJECT"
author: "Pau Badia, Guillermo Palou, Javier Sanchez"
...
```{r DGE object creation, echo = FALSE}
library(edgeR)
...
legend("topleft", sort(unique(batch)), levels(factor(tumor_latE_se$laterality)), fill=sort(unique(batch)), inset=0.005)
