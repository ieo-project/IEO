...
```{r Sequencing depth, dpi=200, fig.width=14, fig.height=8}
...
```{r Distribution of expression levels among samples, dpi=200, fig.width=7, fig.height=4}
...
```{r Between-sample normalization, dpi=200, dpi=200, fig.width=7, fig.height=4}
...
```{r Hierarchical clustering according to batch effect, dpi=200, fig.width=14, fig.height=8}
...
```{r MDS plots, dpi = 200, fig.width=14, fig.height=8}
...
### 3.1. Estimation of surrogate variables
...
```{r Fold change, dpi = 200, fig.width= 14, fig.height= 4}
