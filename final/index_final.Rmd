...
plot(sampleDendrogram, main="Hierarchical clustering of samples colored by TSS", cex.main = 1.7)
...
plot(sampleDendrogram, main="Hierarchical clustering of samples colored by plate", cex.main = 1.7)
...
plot(sampleDendrogram, main="Hierarchical clustering of samples colored by sample vial", cex.main = 1.7)
...
plot(sampleDendrogram, main="Hierarchical clustering of samples colored by portion analyte", cex.main = 1.7)
...
plotMDS(dge_gender, col = batch,labels = outcome, cex = 0.7,cex.axis = 1.2, cex.lab = 1.6)
...
plotMDS(tumor_stage_dge, col = batch,labels = outcome, cex = 0.7, cex.axis = 1.2, cex.lab = 1.6)
...
plotMDS(tumor_grade_dge, col = batch,labels = outcome, cex = 0.7, cex.axis = 1.2, cex.lab = 1.6)
...
plotMDS(tumor_late_dge, col = batch,labels = outcome, cex = 0.7, cex.axis = 1.2, cex.lab = 1.6)
...
plotMDS(tumor_status_dge, col = batch,labels = outcome, cex = 0.7, cex.axis = 1.2, cex.lab = 1.6)
...
hist(tt$P.Value, xlab = "Raw P-values", main = "", las = 1, cex.axis = 1, cex.lab = 1.5)
qqt(fit$t[, 2], df = fit$df.prior + fit$df.residual, main = "", pch = ".", cex = 3, cex.axis = 1, cex.lab = 1.5)
abline(0, 1, lwd = 2)
```
...
qqnorm(zS, cex.lab = 1.5, cex.axis = 1)
abline(0, 1)
