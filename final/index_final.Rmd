...
genesGS1 <- colnames(Im)[which(Im[names(rnkGSz5)[3], ] == 1)]
genesGS2 <- colnames(Im)[which(Im[names(rnkGSz5)[8], ] == 1)]
genesGS3 <- colnames(Im)[which(Im[names(rnkGSz5)[9], ] == 1)]
...
par(mfrow = c(1, 3), mar = c(4, 5, 3, 4))
genesGS1 <- colnames(Im)[which(Im[names(rnkGSx5)[1], ] == 1)]
genesGS2 <- colnames(Im)[which(Im[names(rnkGSx5)[45], ] == 1)]
genesGS3 <- colnames(Im)[which(Im[names(rnkGSx5)[36], ] == 1)]
...
# For loop to plot all interesting pathways
#for (i in pathways){
  #topgsgenes <- colnames(Im)[which(Im[names(rnkGSx3)[i], ] == 1)]
