...
length(zS) 
# Number of pathways upregulated/downregulated: 83/124 (gene set size of 5) or 211/170 (gene set size of 3)
table(zS>0)
...
# Number of pathways significantly enriched (FDR < 0.01): 187 (gene set size of 5) or 353 (gene set size of 3)
sum(pvadj_zs < 0.01)
